function SkillsCapsul(props) {
  return (
    <div key={props.id} className='cursor-pointer w-32 sm:w-40 h-14 border-gray-800 flex items-center hover:flex-row-reverse hover:bg-white/10 duration-700 hover:p-1 justify-between rounded-xl border  ease-in-out hover:border-white
   '>

...
function SkillsCapsul() {
  return (
    <div className=' min-w-40 h-14 border-gray-800 flex items-center hover:flex-row-reverse duration-700 hover:m-1 justify-between rounded-xl border  ease-in-out hover:border-white
   '>

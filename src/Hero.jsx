    ...
    <div className='w-full' ref={ref}>
      <div>
        <div className='flex flex-col  gap-10'>
          <h1 className='font-inter text-5xl sm-text-6xl md:text-7xl lg:text-8xl uppercase leading-heroLine tracking-heroSpacing text-left'>i'm <span className='text-sm text-neutral-900'>Not yet please hire me</span> <br />S{Math.floor(scrollY)/2}ftware <br /> Engineer </h1>
          <button className='bg-white text-black py-2 px-10 w-fit font-inter font-semibold' onClick={contactScroll}> Get in </button>
        </div>

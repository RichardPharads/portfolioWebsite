...
const Contact = React.forwardRef((_, ref) => {
  return (
    <div className='pt-20' ref={ref}>
      <div className='w-full h-screen bg-redBg flex flex-col px-10 gap-32 justify-center'>
        ...
        <div className='ml-auto'>
          <h3 className='font-inter font-medium text-md hover:text-red-300 md:text-2xl'>
            Get in <span className='font-inter text-6xl md:text-9xl font-bold hover:font-thin duration-500 ease-in-out cursor-grab hover:text-white'>touch</span>
          </h3>
        </div>
